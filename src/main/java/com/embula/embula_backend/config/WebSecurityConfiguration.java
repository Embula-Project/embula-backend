    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/login/authentication", "/api/v1/login/logout", "/api/v1/login/refresh-token", "/api/v1/user/register-user","/api/v1/fooditem/getAllFoodItems", "/api/v1/contact-us").permitAll() // public endpoints
